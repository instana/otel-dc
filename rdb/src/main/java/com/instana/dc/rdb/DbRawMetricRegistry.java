...
public class DbRawMetricRegistry {
    private final Map<String, RawMetric> map = new ConcurrentHashMap<String, RawMetric>() {{
        ...
        put(DB_CACHE_READ_RATIO_NAME, new RawMetric(UPDOWN_COUNTER, DB_CACHE_READ_RATIO_NAME, DB_CACHE_READ_RATIO_DESC, DB_CACHE_READ_RATIO_UNIT, true, null));
        put(DB_CACHE_WRITE_RATIO_NAME, new RawMetric(UPDOWN_COUNTER, DB_CACHE_WRITE_RATIO_NAME, DB_CACHE_WRITE_RATIO_DESC, DB_CACHE_WRITE_RATIO_UNIT, true, null));
