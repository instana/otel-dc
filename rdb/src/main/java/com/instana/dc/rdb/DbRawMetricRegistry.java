...
public class DbRawMetricRegistry {
    private final Map<String, RawMetric> map = new ConcurrentHashMap<String, RawMetric>() {{
        ...
        put(DB_DISK_WRITES_NAME, new RawMetric(UPDOWN_COUNTER, DB_DISK_WRITES_NAME, DB_DISK_WRITES_DESC, DB_DISK_WRITES_UNIT, true, null));
        put(DB_DISK_READS_NAME, new RawMetric(UPDOWN_COUNTER, DB_DISK_READS_NAME, DB_DISK_READS_DESC, DB_DISK_READS_UNIT, true, null));
        ...
        put(DB_DATABASE_ANSI_COMPLIANT_NAME, new RawMetric(GAUGE, DB_DATABASE_ANSI_COMPLIANT_NAME, DB_DATABASE_ANSI_COMPLIANT_DESC, UNIT_BY, true, DB_DATABASE_ANSI_COMPLIANT_KEY));
        ...
        put(DB_DATABASE_CASE_INSENSITIVE_NAME, new RawMetric(GAUGE, DB_DATABASE_CASE_INSENSITIVE_NAME, DB_DATABASE_CASE_INSENSITIVE_DESC, UNIT_BY, true, DB_DATABASE_CASE_INSENSITIVE_KEY));
