...
public class DbRawMetricRegistry {
    private final Map<String, RawMetric> map = new ConcurrentHashMap<String, RawMetric>() {{
        ...
        put(DATABASE_LOCK_TABLE_OVERFLOW_NAME, new RawMetric(UPDOWN_COUNTER, DATABASE_LOCK_TABLE_OVERFLOW_NAME, DATABASE_LOCK_TABLE_OVERFLOW_DESC, DATABASE_LOCK_TABLE_OVERFLOW_UNIT, true, null));
        put(DATABASE_TRANSACTION_OVERFLOW_NAME, new RawMetric(UPDOWN_COUNTER, DATABASE_TRANSACTION_OVERFLOW_NAME, DATABASE_TRANSACTION_OVERFLOW_DESC, DATABASE_TRANSACTION_OVERFLOW_UNIT, true, null));
        put(DATABASE_USER_OVERFLOW_NAME, new RawMetric(UPDOWN_COUNTER, DATABASE_USER_OVERFLOW_NAME, DATABASE_USER_OVERFLOW_DESC, DATABASE_USER_OVERFLOW_UNIT, true, null));
        put(DATABASE_SEQ_SCAN_NAME, new RawMetric(UPDOWN_COUNTER, DATABASE_SEQ_SCAN_NAME, DATABASE_SEQ_SCAN_DESC, UNIT_BY, true, DATABASE_SEQ_SCAN_KEY));
        put(DATABASE_SEQ_SCAN_TABLE_NAME, new RawMetric(GAUGE, DATABASE_SEQ_SCAN_TABLE_NAME, DATABASE_SEQ_SCAN_TABLE_DESC, DATABASE_SEQ_SCAN_TABLE_UNIT, true, null));
    }};
