...
public class ApplianceRawMetricRegistry {
    ...
    private final Map<String, RawMetric> map = new ConcurrentHashMap<String, RawMetric>() {{
        ...
        put(SYSTEM_NETWORK_CONNECTIONS_NAME, new RawMetric(GAUGE, SYSTEM_NETWORK_CONNECTIONS_NAME, SYSTEM_NETWORK_CONNECTIONS_DESC, SYSTEM_NETWORK_CONNECTIONS_UNIT, true, "state", MeterName.NETWORK));
