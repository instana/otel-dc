...
| `db.instance.host`                                                                                                                          | string | The hostname of the db instance                                                                                                                                  | estrogen1.fyre.ibm.com      | Conditionally Required                     |
| `service.name`                                                                                                                              | string | This attribute is used to describe the entity name.                                                                                                              | damengdb@DMSERVER           | Required                                   |
| `service.instance.id`                                                                                                                       | string | This attribute is used to describe the entity ID of the current object and consists of server.address, server.port, and db.instance.name.                        | db.testdb.com:5236@db2inst1 | Conditionally Required: If applicable.     |
| `db.entity.parent.id`                                                                                                                       | string | This attribute is used to describe the parent entity ID of the current object and consists of server.address, server.port and db.name or instance.name together. | db.testdb.com:5236@DAMENG   | Conditionally Required: If applicable.     |
...
All metrics in `db.database` instruments should be attached to a [Database resource](../database/database-metrics.md) and therefore inherit its attributes, like `db.database.system`.
...
| `db.database.count`        | The total number of databases of database.           | {database} | UpDownCounter   | Int        | Recommended       |                  |                  |
| `db.database.active.count` | The total number of active databases of database.    | {database} | UpDownCounter   | Int        | Recommended       |                  |                  |
